...
@NamedQueries({
    ...
    , @NamedQuery(name = "Envio.findByProyecto", query = "SELECT e FROM Envio e WHERE e.proyecto = :proyecto order by e.envioPK.fecha")
    , @NamedQuery(name = "Envio.findDinero", query = "SELECT Count(e.cantidad) FROM Envio e WHERE e.proyecto = :proyecto")
