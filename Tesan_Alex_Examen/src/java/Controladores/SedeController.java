...
public class SedeController implements Serializable {
    ...
    private Inspectoria MiInspectoria;
    private List<Sede> listaSedes;
    private Sede EstaSede;
    private List<Responsable> listaResponsables;
    private List<Sederesponsable> listaSedesResponsables;

    public List<Sederesponsable> getListaSedesResponsables() {
        return listaSedesResponsables;
    }

    public void setListaSedesResponsables(List<Sederesponsable> listaSedesResponsables) {
        this.listaSedesResponsables = listaSedesResponsables;
    }
    ...
    public Sede getEstaSede() {
        return EstaSede;
    }

    public void setEstaSede(Sede EstaSede) {
        this.EstaSede = EstaSede;
    }
    ...
    public Inspectoria getMiInspectoria() {
        return MiInspectoria;
    }

    public void setMiInspectoria(Inspectoria MiInspectoria) {
        this.MiInspectoria = MiInspectoria;
    }
    ...
    public void cargar_sedes(){
        listaSedes = ejbFacade.cargarListaSedes(MiInspectoria);
    }
    public void cargar_responsables(){
        listaSedesResponsables = ejbFacade.cargarListaResponsables(EstaSede);
    }
